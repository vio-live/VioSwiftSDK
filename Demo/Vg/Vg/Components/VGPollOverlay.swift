...
/// Componente de encuesta/poll para VG
                            ...
                            AsyncImage(url: URL(string: campaignLogo)) { phase in
                                ...
                                case .success(let image):
                                    image
                                        ...
                                        .onAppear {
                                            print("✅ [VGPollOverlay] Logo del sponsor cargado: \(campaignLogo)")
                                        }
                                case .empty:
                                    ProgressView()
                                        .scaleEffect(0.5)
                                        ...
                                        .onAppear {
                                            print("⏳ [VGPollOverlay] Cargando logo del sponsor: \(campaignLogo)")
                                        }
                                case .failure(let error):
                                    EmptyView()
                                        .onAppear {
                                            print("❌ [VGPollOverlay] Error cargando logo del sponsor: \(error.localizedDescription)")
                                        }
                                @unknown default:
                                    EmptyView()
                                }
                    ...
                    AsyncImage(url: URL(string: avatarUrl)) { phase in
                        ...
                        case .success(let image):
                            ...
                            Circle()
                                ...
                                .onAppear {
                                    print("✅ [VGPollOverlay] Avatar cargado para \(option.text): \(avatarUrl)")
                                }
                        case .empty:
                            Circle()
                                ...
                                .onAppear {
                                    print("⏳ [VGPollOverlay] Cargando avatar para \(option.text): \(avatarUrl)")
                                }
                        case .failure(let error):
                            ...
                            Circle()
                                ...
                                .onAppear {
                                    print("❌ [VGPollOverlay] Error cargando avatar para \(option.text): \(error.localizedDescription)")
                                }
                        @unknown default:
                            EmptyView()
                        }
