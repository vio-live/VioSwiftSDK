...
// MARK: - League Table
public struct LeagueTable: Identifiable {
    public let id: UUID
    public let season: String
    public let teams: [TeamStanding]

    public init(id: UUID = UUID(), season: String, teams: [TeamStanding]) {
        self.id = id
        self.season = season
        self.teams = teams
    }
...
public struct TeamStanding: Identifiable {
    public let id: UUID
    public let rank: Int
    ...
    public let form: [MatchResult]

    public init(id: UUID = UUID(), rank: Int, team: Team, gamesPlayed: Int, wins: Int, draws: Int, losses: Int, goalDifference: Int, points: Int, form: [MatchResult]) {
        self.id = id
        self.rank = rank
        self.team = team
    ...
    public enum MatchResult: String {
        case win = "W"
        case draw = "D"
        case loss = "L"
...
public struct MatchStatistics {
    ...
    public let stats: [Statistic]

    public init(homeTeam: Team, awayTeam: Team, stats: [Statistic]) {
...
public struct Statistic: Identifiable {
    public let id: UUID
    ...
    public init(id: UUID = UUID(), name: String, homeValue: Double, awayValue: Double, unit: String?) {
        self.id = id
        self.name = name
...
public struct MatchEvent: Identifiable {
    public let id: UUID
    ...
    public init(id: UUID = UUID(), minute: Int, type: EventType, player: String?, team: TeamSide, description: String?, score: String?) {
        self.id = id
        self.minute = minute
        self.type = type
        self.player = player
...
public struct TeamLineup {
    ...
    public init(team: Team, formation: String, players: [Player], substitutes: [Player], coach: String?) {
        self.team = team
...
public struct Player: Identifiable {
    ...
    public init(id: UUID = UUID(), number: Int, name: String, position: PlayerPosition, isCaptain: Bool, isSubstitute: Bool) {
        self.id = id
        self.number = number
        self.name = name
...
extension LeagueTable {
    public static let premierLeague: LeagueTable = LeagueTable(
        season: "2024/25",
        teams: [
            TeamStanding(rank: 1, team: Team(name: "Arsenal", shortName: "Arsenal", logo: "arsenal_logo"), gamesPlayed: 16, wins: 11, draws: 3, losses: 2, goalDifference: 20, points: 36, form: [.win, .win, .draw, .win, .win]),
            TeamStanding(rank: 2, team: Team(name: "Manchester City", shortName: "Man City", logo: "city_logo"), gamesPlayed: 16, wins: 11, draws: 1, losses: 4, goalDifference: 22, points: 34, form: [.win, .win, .loss, .win, .draw]),
            TeamStanding(rank: 3, team: Team(name: "Aston Villa", shortName: "Aston Villa", logo: "villa_logo"), gamesPlayed: 16, wins: 10, draws: 3, losses: 3, goalDifference: 8, points: 33, form: [.win, .draw, .win, .win, .loss]),
            TeamStanding(rank: 4, team: Team(name: "Chelsea", shortName: "Chelsea", logo: "chelsea_logo"), gamesPlayed: 16, wins: 8, draws: 4, losses: 4, goalDifference: 12, points: 28, form: [.win, .draw, .win, .loss, .win]),
            TeamStanding(rank: 5, team: Team(name: "Crystal Palace", shortName: "Crystal Palace", logo: "palace_logo"), gamesPlayed: 16, wins: 7, draws: 5, losses: 4, goalDifference: 5, points: 26, form: [.draw, .win, .loss, .win, .draw]),
            TeamStanding(rank: 8, team: Team(name: "Manchester United", shortName: "Man Utd", logo: "manutd_logo"), gamesPlayed: 15, wins: 7, draws: 4, losses: 4, goalDifference: 4, points: 25, form: [.win, .loss, .draw, .win, .win])
        ]
    )
}

extension MatchStatistics {
    public static func mock(for match: Match) -> MatchStatistics {
        MatchStatistics(
...
extension MatchTimeline {
    public static func mock(for match: Match) -> MatchTimeline {
        MatchTimeline(
            events: [
                MatchEvent(minute: 0, type: .kickOff, player: nil, team: .home, description: nil, score: "0-0"),
                MatchEvent(minute: 5, type: .substitution(on: "A. Scott", off: "T. Adams"), player: "A. Scott", team: .away, description: nil, score: nil),
                ...
                MatchEvent(minute: 25, type: .yellowCard, player: "M. Tavernier", team: .away, description: nil, score: nil)
            ]
        )
    }
}
...
extension TeamLineup {
    public static func mockHome(for match: Match) -> TeamLineup {
        TeamLineup(
            team: match.homeTeam,
            formation: "4-3-3",
            players: [
    ...
    public static func mockAway(for match: Match) -> TeamLineup {
        TeamLineup(
            team: match.awayTeam,
            formation: "4-4-2",
            players: [
