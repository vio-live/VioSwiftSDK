...
public struct VCastingChatOverlay: View {
                    ...
                    VStack(spacing: 0) {
                        ...
                        .background(
                            RoundedRectangle(cornerRadius: 20)
                                .fill(VCastingTheme.Colors.darkGray.opacity(0.4))
                                .background(
                                    RoundedRectangle(cornerRadius: 20)
    ...
    private var dragHandle: some View {
        VStack(spacing: isLandscape ? 2 : 4) {
            ...
            HStack(spacing: isLandscape ? 6 : 8) {
                ...
                .padding(EdgeInsets(top: isLandscape ? 3 : 5, leading: isLandscape ? 6 : 10, bottom: isLandscape ? 3 : 5, trailing: isLandscape ? 6 : 10))
                .background(
    ...
    private var chatInputBar: some View {
        HStack(spacing: 10) {
            Circle()
                .fill(VCastingTheme.Colors.brandGradient)
            ...
            TextField("Send a message...", text: $messageText)
                .font(.system(size: 13))
                .foregroundColor(.white)
                .accentColor(VCastingTheme.Colors.pink)
            ...
            Button(action: {
                ...
                Image(systemName: "hand.thumbsup.fill")
                    ...
                    .foregroundColor(VCastingTheme.Colors.pink)
                    .padding(10)
                    .background(
                        Circle()
                            .fill(VCastingTheme.Colors.pink.opacity(0.2))
                    )
            }
            Button(action: {
                sendMessage()
                ...
                Image(systemName: "paperplane.fill")
                    .font(.system(size: 18, weight: .semibold))
                    .foregroundColor(messageText.isEmpty ? .white.opacity(0.3) : VCastingTheme.Colors.pink)
                    .padding(10)
                    .background(
                        Circle()
                            .fill(messageText.isEmpty ? Color.white.opacity(0.1) : VCastingTheme.Colors.pink.opacity(0.2))
                    )
            }
    ...
    private func sendMessage() {
        ...
        let message = ChatMessage(
            username: "Angelo",
            text: messageText,
            usernameColor: VCastingTheme.Colors.pink,
            likes: 0,
            timestamp: Date()
        )
...
struct FloatingLikeView: View {
    ...
    var body: some View {
        Image(systemName: "hand.thumbsup.fill")
            ...
            .foregroundColor(VCastingTheme.Colors.pink)
            .shadow(color: VCastingTheme.Colors.pink.opacity(0.5), radius: 8, x: 0, y: 0)
            .scaleEffect(scale)
